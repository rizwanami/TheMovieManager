...
class TMDBClient : NSObject {
    ...
    func taskForPOSTMethod(method: String, parameters: [String:AnyObject], jsonBody: String, completionHandlerForPOST: @escaping (_ result: AnyObject?, _ error: NSError?) -> Void) -> URLSessionDataTask {
        ...
        parameters[TMDBClient.ParameterKeys.ApiKey] = Constants.ApiKey as AnyObject?
        let request = NSMutableURLRequest(url: TMDBClient.tmdbURLFromParameters(parameters as [String : AnyObject], withPathExtension: method))
